...
(function () {
    ...
    function findMountPoint() {
        ...
        return (
            ...
            document.querySelector('.walletCard') ||
    ...
    function insertCard(card) {
        ...
        if (mount.classList && mount.classList.contains('walletCard')) {
            // Dashboard's wallet card — place the account card right after
            // it (below Wallet Balance / Fund Wallet), not above everything.
