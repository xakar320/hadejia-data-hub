...
function updateEstimate() {
    ...
    if (smsPlan && units > 0) {
        const pricePerUnit =
            isReseller && smsPlan.reseller_price_per_unit !== null && smsPlan.reseller_price_per_unit !== undefined
                ? Number(smsPlan.reseller_price_per_unit)
                : Number(smsPlan.price_per_unit || 0);
