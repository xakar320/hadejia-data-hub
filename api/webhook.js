...
async function webhookHandler(req, res) {
  ...
  if (txn.status !== 'pending') {
    // Already finalized — either the synchronous purchase call
    // resolved it, or an earlier webhook delivery for this same event
    // already did. Acknowledge without reprocessing (AutosyncNG may
    // retry webhook delivery; this makes that safe).
